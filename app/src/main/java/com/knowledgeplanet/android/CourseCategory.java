...
public class CourseCategory extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent mainIntent = new Intent(CourseCategory.this, SubCourseActivity.class);
                mainIntent.putExtra("courseName",courses.getTitle());
    ...
    private void prepareCourseData() {
        Courses courses = new Courses("Computer");
    ...
    private void goToLoginActivity(FirebaseUser user) {
        Intent mainIntent = new Intent(CourseCategory.this, LoginActivity.class);
        startActivity(mainIntent);
        finish();
    }
